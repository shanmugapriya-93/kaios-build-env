...
/**
 * @file EcrioPAL.cpp
 * @brief This is the implementation of the Ecrio PAL's instance handling.
 */
...
/**
 * This function is used to initialize the Linux PAL.
 */
u_int32 pal_Init
(
	LOGHANDLE logHandle,
...
)
{
	...
	*pal = NULL;
	...
	pal_LogMessage(logHandle, KLogLevelInfo, KLogComponentPAL, KLogTypeFuncEntry, "%s:%u", __FUNCTION__, __LINE__);
	...
	*pal = (PALINSTANCE)h;
	...
	pal_LogMessage(logHandle, KLogLevelInfo, KLogComponentPAL, KLogTypeFuncExit, "%s:%u", __FUNCTION__, __LINE__);
