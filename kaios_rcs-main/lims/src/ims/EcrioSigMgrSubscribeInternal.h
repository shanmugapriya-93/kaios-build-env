...
#ifndef _ECRIO_SIG_MGR_SUBSCRIBE_INTERNAL_H_
#define  _ECRIO_SIG_MGR_SUBSCRIBE_INTERNAL_H_

typedef struct
{
	/** Branch parameter of Invite.*/
	u_char *pBranch;
	/** Application data*/
	void *pData;
	/** Sig Mgr Context */
	void *pSigMgr;
	/** Subscribe state*/
	EcrioSigMgrSubscribeState eState;
	// int eState;
	/** Response retransmit TimerID*/
	TIMERHANDLE refreshTimerId;
	/** Subscribe Req*/
	EcrioSigMgrSipMessageStruct *pSubscribeReq;
} _EcrioSigMgrSubscribeUsageInfoStruct;
...
#endif	// _ECRIO_SIG_MGR_SUBSCRIBE_INTERNAL_H_
