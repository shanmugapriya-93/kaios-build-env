...
/*****************************************************************************
  ...
  Input:		  SIGMGRHANDLE sigMgrHandle - Signaling Manager Instance.
                  ...
                  EcrioSigMgrSipMessageStruct* pReferReq - REFER request Headers.
...
)
{
	...
	if (pReferReq == NULL || pCallId == NULL || pStruct == NULL)
	{
	...
	error = _EcrioSigMgrSendRefer(pSigMgr, pCallId, pStruct, pReferReq, ppReferId);
