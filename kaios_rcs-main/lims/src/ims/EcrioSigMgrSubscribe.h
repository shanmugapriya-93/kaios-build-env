...
#ifndef _ECRIO_SIG_MGR_SUBSCRIBE_H_
#define  _ECRIO_SIG_MGR_SUBSCRIBE_H_

typedef enum
{
	EcrioSigMgrSubscribeStateNone = 0,
	EcrioSigMgrSubscribeStateActive,
	EcrioSigMgrSubscribeStateReSubcribeProgress,
	EcrioSigMgrSubscribeStateReSubcribeTimerExpired
} EcrioSigMgrSubscribeState;
...
} EcrioSigMgrSendSubscribeStruct;
...
#endif	// _ECRIO_SIG_MGR_SUBSCRIBE_H_
