...
#ifndef _ECRIO_SIG_MGR_INSTANT_MESSAGE_INTERNAL_H_
#define  _ECRIO_SIG_MGR_INSTANT_MESSAGE_INTERNAL_H_
...
/**
*API for send Message Response.
*@Param IN EcrioSigMgrStruct* pSigMgr - Pointer to signaling manager.
*@Param IN EcrioSigMgrMessageResponseStruct* pMessageResp - Message Response Info.
*@Param IN BoolEnum bOverride - if Enum_TRUE send override message callback to upper layer.
*@Return	u_int32 Error code
*/
...
/**
*API for handling incoming Message Request.
*@Param IN EcrioSigMgrStruct* pSigMgr - Pointer to signaling manager.
*@Param IN EcrioSigMgrSipMessageStruct* pMessageReqNtf - Message Info.
...
/**
*API for handling incoming Message Responses.
*@Param IN EcrioSigMgrStruct* pSigMgr - Pointer to signaling manager.
