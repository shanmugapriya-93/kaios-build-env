...
Copyright (c) 2015-2021 Ecrio, Inc. All Rights Reserved.
...
/**
* @file lims_SetUserAgent.c
* @brief Implementation of lims set UserAgent functionality.
*/
...
)
{
	...
	uSigMgrError = EcrioSigMgrSetUserAgent(m->pSigMgrHandle, pUserAgent);
